...
class TestModelManager:
    ...
    async def test__get_model_configs(self):
        ...
        try:
            ...
            configs[0].config.model_family = 'OpenAI'
    ...
    async def test__save_model_config_new(self):
        ...
        try:
            ...
            assert saved_config.config.model_family == 'Test Family'
    ...
    async def test__save_model_config_update(self):
        ...
        try:
            ...
            assert updated_config.config.model_family == 'Updated Family'
    ...
    async def test__get_model_config(self):
        ...
        try:
            ...
            assert config.config.model_family == configs[0].config.model_family
